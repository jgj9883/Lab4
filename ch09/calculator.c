...
int main(int argc, char *argv[])
{
    ...
    create_num_button(hbox2, button, "1");
    create_num_button(hbox2, button, "2");
    create_num_button(hbox2, button, "3");
    ...
    create_num_button(hbox4, button, "7");
    create_num_button(hbox4, button, "8");
    create_num_button(hbox4, button, "9");
